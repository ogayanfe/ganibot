...
export default function ChatFooter() {
  ...
  return (
    <footer className="flex justify-center items-center gap-10 py-6 border-gray-800 h-[200px] fixed bottom-0 w-screen text-gray-900 dark:text-gray-50 bg-inherit dark:bg-[#090909] object-cover">
