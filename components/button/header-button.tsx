      ...
      >
        ...
        >
          <ComponentVisiblity show={iconPosition === "start"}>
            <motion.span initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.4, delay: 0.1 }}>
              {icon}
            </motion.span>
          </ComponentVisiblity>

          <motion.span initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.15 }}>
            {title}
          </motion.span>
